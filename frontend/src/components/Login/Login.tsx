  ...
  return (
    <div className="bg-transparent border-stroke dark:border-strokedark xl:border-l-2 w-full h-full relative z-[10]">
      <div className="flex px-10 items-center justify-center flex-col">
        <h1 className="text-[#45475B] mt-4 font-semibold text-[2vw]">
          Welcome To Waterfly
        </h1>
        <div>
          <div className=" flex gap-2 items-center flex-col my-4">
            <span className="text-xs">email:khatrirohit198@gmail.com</span>
            <span className="text-xs">password:rohitkhatri98</span>
          </div>
          <Formik
            ...
            {({
              ...
              >
                ...
                <div className="flex flex-col gap-1 w-[20vw] relative items-center">
                  <label
                    className="self-start text-[#2e2e2e]"
                    htmlFor="password"
                  >
                    Enter Password*
                  </label>
